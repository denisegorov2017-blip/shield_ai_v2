...
- **FR-005**: Система ДОЛЖНА покрывать основные функции типизацией (MyPy strict) и юнит-тестами
- **FR-06**: Система ДОЛЖНА разделять архитектуру на слои: domain, application, infrastructure, presentation
...
- **SC-003**: 100% покрытие юнит-тестами для основных функций расчёта усушки
- **SC-004**: Пользователи могут выполнить полный цикл: импорт → расчёт → экспорт → аудит за менее чем 5 минут
- **SC-005**: 90% удовлетворенности пользователей с упрощённым интерфейсом и процессами
