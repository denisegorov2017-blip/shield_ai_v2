...
from shield_ai.infrastructure.database.models import ProductModel, BatchModel, SaleModel, ShrinkageCoefficientModel
...
class ForecastShrinkageUseCase:
    ...
    def _get_coefficients(self, product_id: int) -> Dict:
